...
export default function NodeTray() {
  ...
  // ⚡ Bolt Optimization: Pre-compute a Map to replace O(N*M) nested array lookups
  // (.find inside .reduce) with O(1) lookups during array traversal, reducing overall complexity to O(N).
  ...
  }, [mode, pipelineOrder, nodes, nodeMap]);
