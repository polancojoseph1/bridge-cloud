 ...
 * 💡 What: Prevents InstanceTab from re-rendering unless its props (instanceId) change.
 * 🎯 Why: InstanceTabBar frequently updates its internal state (canScrollLeft, canScrollRight) during user scroll.
 *         Without memo, EVERY single instance tab re-rendered during scroll events, causing CPU overhead.
 * 📊 Impact: Prevents O(N) list re-renders during horizontal scroll operations.
 */
