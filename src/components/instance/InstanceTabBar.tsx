...
// ⚡ Bolt: Wrapped with React.memo to prevent O(N) re-renders when parent scroll state (canScrollLeft/Right) updates.
...
// ⚡ Bolt: Wrapped with React.memo to prevent O(N) re-renders when parent scroll state updates.
