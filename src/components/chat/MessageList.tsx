...
export default function MessageList({ conversationId }: MessageListProps) {
  ...
  const handleScroll = () => {
    ...
    // Fix: Using Math.ceil(scrollTop + clientHeight) handles fractional pixel values on zoom levels
  ...
  return (
    <div
      ...
      onWheel={() => { isProgrammaticScrollRef.current = false; expectedScrollTop.current = null; }}
      onTouchMove={() => { isProgrammaticScrollRef.current = false; expectedScrollTop.current = null; }}
      onMouseDown={() => { isProgrammaticScrollRef.current = false; expectedScrollTop.current = null; }}
      onTouchStart={() => { isProgrammaticScrollRef.current = false; expectedScrollTop.current = null; }}
