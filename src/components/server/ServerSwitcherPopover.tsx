    ...
    >
      ...
      {profiles.map(profile => (
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2.5 hover:bg-[#152219] focus-visible:bg-[#152219] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#10a37f] transition-colors duration-100 text-left"
        >
          <span
      ...
      <div className="border-t border-[#2d4035] mt-1 pt-1">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2.5 hover:bg-[#152219] focus-visible:bg-[#152219] focus-visible:text-[#ececec] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#10a37f] transition-colors text-left text-[13px] text-[#8e8e8e] hover:text-[#ececec]"
        >
          <Plus size={13} />
          Add server
        </button>
      ...
      <div className="border-t border-[#2d4035] mt-1 pt-1 pb-1">
        ...
        <Show when="signed-out">
          <SignInButton mode="modal">
            <button className="w-full flex items-center gap-2.5 px-3 py-2.5 hover:bg-[#152219] focus-visible:bg-[#152219] focus-visible:text-[#ececec] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#10a37f] transition-colors text-left text-[13px] text-[#8e8e8e] hover:text-[#ececec]">
              <LogIn size={13} />
              Log in
            </button>
          </SignInButton>
