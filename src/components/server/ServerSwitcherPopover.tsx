...
export default function ServerSwitcherPopover({ onClose }: Props) {
  ...
  // ⚡ Bolt Optimization: Using individual selectors prevents the component from re-rendering
  // on unrelated store state changes (which happens when destructuring the entire store object).
