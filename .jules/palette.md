...
## 2024-05-24 - AutoFocus Primary Chat Inputs
**Learning:** Users navigating to a chat view or empty state expect to start typing immediately. Requiring an extra click creates friction and slows down interaction.
**Action:** Always add `autoFocus` to the primary text inputs (like `<textarea>`) in chat interfaces and empty states to enable instant keyboard interaction.
