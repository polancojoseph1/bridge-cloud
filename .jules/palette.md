...
## 2026-04-15 - Chat Input AutoFocus
**Learning:** Users experience friction when navigating to a new chat or empty state and having to manually click the input field before typing.
