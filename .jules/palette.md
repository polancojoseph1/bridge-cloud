...
## 2026-05-12 - Add autoFocus to chat inputs
**Learning:** Adding `autoFocus` to primary text inputs in chat interfaces enables instant keyboard interaction and reduces friction for users navigating to a chat.
**Action:** Always add `autoFocus` to primary text inputs in chat interfaces and empty states.
