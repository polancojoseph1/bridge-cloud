...
## 2024-05-26 - Target _blank vulnerability missing rel="noopener noreferrer"
**Vulnerability:** A cross-site scripting (XSS) / reverse tabnabbing vulnerability can occur when using target="_blank" without rel="noopener noreferrer". A page opened in a new tab can manipulate the window.opener.location of the original page.
**Learning:** Never use target="_blank" without also adding rel="noopener noreferrer" or just rel="noopener" to prevent the newly opened page from having access to the original page's window object.
**Prevention:** In React or regular HTML, always pair target="_blank" with rel="noopener noreferrer".
